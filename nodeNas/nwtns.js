...
app.use('/public/img', static(path.join(__dirname, 'public/img')));
...
router.route('/process/login').post(function(req, res) {
    ...
    var paramPassword = req.body.userPass || req.query.userPass;
		...
		authUser(database, paramId, paramPassword, function(err, docs) {
			...
			if (docs) {
				...
				var rsData = new Object();
					rsData.RETURN_CODE = "200";
					rsData.RETURN_MSG  = "로그인 성공";
//				var userInfo = new Object();
//					userInfo.userId = paramId;
//					userInfo.userPass = paramPassword;
					rsData.DATA = docs[0];
				res.json(rsData);
			
			} else {  // 조회된 레코드가 없는 경우 실패 응답 전송
				var rsData = new Object();
					rsData.RETURN_CODE = "500";
					rsData.RETURN_MSG  = "로그인 실패";
				res.json(rsData);
			}
		});
